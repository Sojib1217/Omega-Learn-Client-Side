...
const coursePromise = fetch('https://omega-learn-server.vercel.app/courses').then(res => res.json())
    ...
    <section>
      ...
      <div className='px-4 md:px-20 min-h-screen pb-4 md:pb-10'>
        <h1 data-aos="fade-down"
          data-aos-duration="200" className='text-4xl font-bold text-center mt-10 max-h-screen'>All <span className='text-amber-700'>Courses</span> Here</h1>
        <div className='md:flex justify-between mt-5 mx-4 md:mx-20 md:mt-10'>
          <h1 className='text-2xl font-bold text-center'>Total Course <span className='text-amber-700'>({courses.length})</span></h1>
        ...
        {loading ?
          (<Loading></Loading>) : filterCourse.length > 0 ? <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10'>
            ...
            <div className='text-center my-32'>
              <p className="text-center text-5xl text-gray-500 ">No <span className='text-amber-700'>Course</span> Found</p>
